...
with right:
    ...
    num_affected = st.number_input(
        "Est. Persons Affected", min_value=0, value=1, step=1, key="inc_affected",
        help="Approximate number of people directly involved or affected by this incident",
    )
...
"""
        ...
        st.markdown(
            ...
            f'border-radius:12px;padding:1.5rem;font-family:monospace;font-size:0.88rem;'
